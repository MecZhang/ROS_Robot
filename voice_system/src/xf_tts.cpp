...
const char* fileName = "/home/yuntao/Music/voice.wav";
const char* playPath = "play /home/yuntao/Music/voice.wav";
...
/**
 * make topic call back text to wav file.
 */
int makeTextToWav(const char* text, const char* filename)
{
	int         ret                  = MSP_SUCCESS;
	const char* login_params         = "appid = 592fc537, work_dir = .";//登录参数,appid与msc库绑定,请勿随意改动
	/*
	* rdn:           合成音频数字发音方式
	* volume:        合成音频的音量
	* pitch:         合成音频的音调
...
{
	const char* start = "科大讯飞在线语音模块启动成功";
